...
##Creates one list of all gene dataframes
len = length(dSNPS)
alldSNP <- list()
for( i in 1:len) {
...
###alldSNP is an important list to use in both graphing and in GeneCan
alldSNP<- alldSNP[allGOI]


###normSigR is just as important 
